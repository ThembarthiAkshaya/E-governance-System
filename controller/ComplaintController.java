...
public class ComplaintController {
	...
	// Method to get all complaints for a specific citizen
	public void getComplaintsByCitizenFromInput() {
		Scanner sc = new Scanner(System.in);

		// Ask for Citizen ID
		System.out.println("Enter Citizen ID to get complaints: ");
		String citizenId = sc.nextLine();

		// Call service to get complaints by citizen ID
		List<Complaint> complaints = complaintService.getComplaintsByCitizen(citizenId);

		if (complaints != null && !complaints.isEmpty()) {
			System.out.println("---- Complaints for Citizen ID: " + citizenId + " ----");
			...
			System.out.println("No complaints found for Citizen ID: " + citizenId);
		}
	}
