...
public class TaxRecord {
	...
	public TaxRecord(String taxId, int fiancialYear, String status,int amount,LocalDate dateOfSubmission, Citizen citizen) {
		super();
		this.taxId = taxId;
	...
	public int getFiancialYear() {
		return fiancialYear;
	}

	public void setFiancialYear(int fiancialYear) {
		this.fiancialYear = fiancialYear;
	}
